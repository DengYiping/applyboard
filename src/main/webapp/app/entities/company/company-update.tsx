    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="applyboardApp.company.home.createOrEditLabel">Create or edit a Company</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : companyEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="fieldLabel" for="field">
                    Field
                  </Label>
                  <AvField id="company-field" type="text" name="field" />
                </AvGroup>
