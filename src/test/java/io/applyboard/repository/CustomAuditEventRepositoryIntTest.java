...
import io.applyboard.config.audit.AuditEventConverter;
import io.applyboard.domain.PersistentAuditEvent;
...
import static io.applyboard.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
